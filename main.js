...
// Acá asignamos el cuadrito donde comienza a caminar el robot.El número se asigna de manera aleatoria.
let randomId = (Math.floor(Math.random() * totalCuadritos) + 1).toString()
